// src/pages/admin/fullmetrix/FmMetrixAdminTab.tsx
...
import { api, API_BASE, getAuthToken } from "@core/api/client";
import { notifyError } from "@shared/components/Notification";
...
export default function FullMetrixAdminPage() {
  ...
  useEffect(() => {
    ...
    if (
      ...
      setTab(tabParam as "active" | "expired" | "pending");
    }
  }, [location.search]);
