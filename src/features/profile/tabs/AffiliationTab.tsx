// src/pages/profil/tabs/AffiliationTab.tsx
                ...
                <div className="flex items-center gap-3">
                  <img
                    src={
                      ...
                      `https://api.dicebear.com/9.x/initials/svg?seed=${encodeURIComponent(
                        a.fullName || "Affilié", // On remplace le fallback par "Affilié"
                      )}`
                    }
                    alt={a.fullName || "Utilisateur anonyme"} // Cache l'email au survol de l'image
                  ...
                  <div className="min-w-0">
                    <div className="text-sm font-medium text-skin-base truncate">
                      {a.fullName || "Utilisateur anonyme"}
                    </div>
                    {/* ❌ La div qui contenait a.email a été supprimée */}

                    {a.joinedAt && (
                      <div className="text-[11px] text-skin-muted/70 mt-0.5">
                        Inscrit le{" "}
