/**
 * Full Metrix - Hero Section
 */
"use client";

import React from "react";
import { ArrowRight, Play, Sparkles, Layers, Notebook, LineChart, Users, MessageSquare } from "lucide-react";
import { primaryBtn, secondaryBtn } from "../ui/styles";
import Image from "next/image";
import FadeIn from "../components/FadeIn";

// Real assets from user
import robotHeroNew from "../../assets/fmmetrix/robot_hero_new.png";
    ...
    <section className="relative min-h-[90vh] flex items-center justify-center pt-20 pb-20 overflow-hidden bg-white dark:bg-zinc-950 transition-colors duration-500">
      ...
      <div className="absolute inset-0 z-0">
        ...
        <Image
          ...
          fill
          className="object-cover opacity-60 dark:opacity-30 dark:invert dark:hue-rotate-180 dark:mix-blend-screen transition-opacity duration-500"
          priority
        />
        {/* Nebulas/Glows */}
          ...
          <div className="flex justify-center lg:justify-start relative">
            <div className="relative w-full max-w-[500px] aspect-square">
              ...
              <FadeIn delay={0} direction="right" className="relative w-full h-full">
                <Image
                  src={require("../../assets/fmmetrix/logo_header_v2.png")}
                  alt="Full Metrix Robot"
                  fill
                  className="object-contain drop-shadow-[0_0_50px_rgba(124,58,237,0.3)] dark:drop-shadow-[0_0_50px_rgba(139,92,246,0.4)] animate-float"
                  priority
                />
              </FadeIn>
            </div>
          ...
          <div className="text-center lg:text-left">
            <FadeIn delay={0.2} direction="left">
              <h1 className="text-6xl md:text-8xl font-bold tracking-tight text-zinc-900 dark:text-white mb-4 drop-shadow-xl dark:drop-shadow-2xl transition-colors duration-300">
                FULL <span className="bg-gradient-to-r from-violet-600 via-fuchsia-600 to-violet-600 dark:from-violet-400 dark:via-fuchsia-400 dark:to-white bg-clip-text text-transparent">METRIX</span>
              </h1>
            </FadeIn>
            ...
            <FadeIn delay={0.4} direction="left">
              <p className="max-w-xl mx-auto lg:mx-0 text-lg text-zinc-600 dark:text-zinc-400 mb-10 leading-relaxed font-light transition-colors duration-300">
                Backtesting, Chat IA, Agent IA, Journal automatique...<br />
                Ton espace professionnel alimenté par l'IA pour passer au niveau supérieur.
              </p>
            </FadeIn>
            ...
            <FadeIn delay={0.5} direction="up">
              <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4">
                ...
                >
                  ...
                  <span>Accéder à Full Metrix</span>
                </button>

                <button
                  className="group inline-flex items-center gap-2 px-8 py-4 rounded-full border border-zinc-200 dark:border-zinc-700 bg-white/50 dark:bg-zinc-900/50 text-zinc-700 dark:text-zinc-300 font-medium transition-all hover:bg-zinc-100 dark:hover:bg-zinc-800 hover:text-black dark:hover:text-white hover:border-zinc-300 dark:hover:border-zinc-500 backdrop-blur-sm"
                >
                  <Play className="h-5 w-5 fill-current transition-transform group-hover:scale-110" />
                  <span>Voir comment ça fonctionne</span>
                </button>
              </div>
            </FadeIn>
          </div>
