...
export default function PlayerDock({
  ...
  // 🛡️ Protection absolue contre les valeurs NaN (Très fréquent avec les balises HTML5 <audio>)
  ...
  const pct = useMemo(() => {
    ...
    return Math.max(0, Math.min(1, safePosition / safeDuration));
        ...
        {safeDuration > 0 && (
          <div className="mt-3">
            <div className="flex items-center justify-between text-[11px] text-skin-muted leading-none mb-1">
              <span>{fmtTime(safePosition)}</span>
