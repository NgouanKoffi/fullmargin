// src/pages/podcasts/MobilePlayerDrawer.tsx
...
export default function MobilePlayerDrawer({
  ...
  const prettyLeft = fmtTime(Math.floor(safePosition));
  const prettyRight = fmtTime(Math.floor(safeDuration));
          ...
          <div className="px-1">
            ...
            <div className="relative h-6 select-none">
              ...
              <input
                ...
                onChange={(e) => {
                  ...
                  if (!Number.isFinite(nextPct) || safeDuration <= 0) return;
                  const sec = (nextPct / 100) * safeDuration;
                  onSeek(sec);
                }}
            ...
            <style>{`
              ...
              .fm-range::-webkit-slider-thumb {
                ...
                background: rgb(var(--fm-primary)); border: 2px solid rgba(255,255,255,.85);
