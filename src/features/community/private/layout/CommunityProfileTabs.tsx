...
import {
  ...
  Copy,
  Check,
  PlayCircle, // <-- Ajout de l'icône pour le bouton
} from "lucide-react";
import AboutTab from "../modules/about/AboutTab";
import OwnerTab, {
  type OwnerView,
  type CommunityStatsDTO,
} from "../modules/owner/OwnerTab";
import OwnerAdminView from "../modules/owner/OwnerAdminView";
...
} from "@features/community/hooks/useCommunitySubscription";
import TutorialVideoModal from "@shared/components/TutorialVideoModal";

// Import du modal tutoriel
...
export default function CommunityProfileTabs({
  ...
  // <-- Nouvel état pour gérer l'ouverture du modal de tutoriel
  ...
  return (
    <div className="space-y-5 w-full">
      ...
      <div className="rounded-2xl bg-white/80 dark:bg-slate-900/30 border border-slate-100/80 dark:border-slate-700/40 px-2 py-2">
        {/* On force le container à prendre 100% de large pour pouvoir pousser le dernier bouton à droite */}
