                      ...
                      return (
                        ...
                        >
                          ...
                          <div className="p-3">
                            ...
                            {c.isCommunityDeleted && (
                              <div className="mt-1.5">
                                <span className="inline-flex items-center rounded-full px-2 py-0.5 text-[11px] font-medium bg-rose-50 text-rose-700 ring-1 ring-inset ring-rose-600/20 dark:bg-rose-900/10 dark:text-rose-400 dark:ring-rose-800/80">
                                  Cette communauté n'existe plus
                                </span>
                              </div>
                            )}
