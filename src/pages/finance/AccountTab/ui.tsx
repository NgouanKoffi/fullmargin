// src/pages/finance/AccountTab/ui.tsx
...
/**
 * Modal rendu dans <body> (portal) pour éviter que le parent le clippe.
 * - overlay plein écran
 * - scroll sur l’overlay
 * - lock du body
 */
export function Modal({
  ...
  useEffect(() => {
    ...
    // on bloque le scroll du document entier
  ...
  return createPortal(
    ...
    >
      ...
      >
        <div
          ref={boxRef}
          className="w-[95vw] max-w-xl rounded-2xl border border-slate-200 dark:border-slate-700
