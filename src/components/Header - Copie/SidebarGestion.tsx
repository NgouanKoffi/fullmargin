...
type Item = {
  ...
  disabled?: boolean; // 👈 nouveau
};

/* ============================ Menus par rôle ============================ */
// Menu complet pour ADMIN — dashboard + service client désactivés
...
export default function SidebarGestion() {
  ...
  const activeItem = "fm-active hover:!bg-[#7c3aed]";
