    ...
    >
      ...
      <div className="mt-1 space-y-2">
        ...
        <button
          ...
          className={`w-full rounded-2xl px-3.5 py-3 ring-1 ring-skin-border/15 bg-skin-surface/80 hover:bg-skin-surface/95 transition-colors flex items-center justify-between gap-3 ${
        ...
        <div
          className="w-full rounded-2xl px-3.5 py-3 ring-1 ring-skin-border/15 bg-skin-surface/50 flex items-center justify-between gap-3 cursor-not-allowed"
          aria-disabled
        >
          <span className="flex items-center gap-3">
            <span className="inline-flex items-center justify-center w-10 h-10 rounded-xl ring-1 ring-skin-border/15 bg-[rgb(var(--tile))] relative">
              ...
              <span className="absolute -top-1 -right-1 inline-flex w-4 h-4 rounded-full bg-white items-center justify-center ring-1 ring-black/10">
