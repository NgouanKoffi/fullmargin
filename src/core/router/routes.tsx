...
/* Layouts */
import DefaultLayout from "@core/layouts/PublicLayout";
import NotFoundLayout from "@core/layouts/NotFoundLayout";

// ✅ Lazy layouts (pas chargés sur la home)
const PlainLayout = lazy(() => import("@core/layouts/PlainLayout"));
const AdminLayout = lazy(() => import("@core/layouts/AdminLayout"));
const PrivateLayout = lazy(() => import("@core/layouts/PrivateLayout"));
const LiveLayout = lazy(() => import("@core/layouts/LiveLayout"));
